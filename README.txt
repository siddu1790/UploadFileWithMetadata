...
The service is just a file upload with meta-data REST service. It uses an in-memory database (H2) to store the data and it also displays all the files uploaded along with the meta data in tabular format.

This application uses default serverport of 8080. if you wish to change, go to application.properties file add "server.port = 8090" without quotes.
